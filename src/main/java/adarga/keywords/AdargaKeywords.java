...
//	     http://www.apache.org/licenses/LICENSE-2.0
	...
	public class AdargaKeywords {
	  ...
	  public static void runExample(
	    ...
	    String text1 = "servicios juridicos";
	    String text2 = "servicios juridicos y financieros";
	    String text3 = "abogados";
	    String negativeText4 = "inmobiliarias malaga";

	    Keyword marsCruiseKeyword = new Keyword();
	    marsCruiseKeyword.setText(text1);
	    ...
	    negativeKeywordEstimateRequest.setKeyword(new Keyword(null, null, null, negativeText4,
	    ...
	    campaignEstimateRequest.setCriteria(new Criterion[] {spain, spanish});
	  ...
	  private static void displayMeanEstimates(String message, StatsEstimate minEstimate,
	    ...
	    Double meanAverageCpc = calculateMean(minEstimate.getAverageCpc(),
	        maxEstimate.getAverageCpc()) / 1000000;
	    ...
	    Double meanTotalCost = calculateMean(minEstimate.getTotalCost(),
	        maxEstimate.getTotalCost()) / 1000000;
	    Double meanTotalImpressions = calculateMean(minEstimate.getImpressionsPerDay(),
		        maxEstimate.getImpressionsPerDay());
	    Double meanCTR = calculateMean(minEstimate.getClickThroughRate(),
		        maxEstimate.getClickThroughRate());

	    System.out.println(message);
	    System.out.printf("\tEstimated average Impressions per day: %s%n", formatMean(meanTotalImpressions));
	    ...
	    System.out.printf("\tEstimated CTR: %s%n%n", formatMean(meanCTR));
	  }
