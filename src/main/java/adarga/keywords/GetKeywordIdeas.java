...
public static void runExample(
 ...
 relatedToQuerySearchParameter.setQueries(new String[] {"adarga"});
 ...
 spanish.setId(1003L);
 languageParameter.setLanguages(new Language[] {spanish});
